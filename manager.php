...
<?php  
  ...
  if(isset($_POST['user']) && isset($_POST['pass'])) {
    ...
    mysqli_close($conn);
      ...
      echo '
        <form method="POST" action="manager.php" novalidate="novalidate">
  ...
  echo '
    <form id="login_form" method="POST" action="manager.php" novalidate="novalidate">
      User: <input id="user" type="text" name="user"><br>
      Pass: <input id="pass" type="password" name="pass"><br>
